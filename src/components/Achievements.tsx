...
const Achievements = () => {
  ...
  return (
    <section id="achievements" ref={sectionRef} className="py-20 md:py-28 bg-gray-100">
      <div className="container-custom">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16 reveal-on-scroll">
            <span className="badge mb-3 bg-black text-white">Key Achievements</span>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {achievements.map((achievement, index) => (
              <div 
                key={index} 
                className="reveal-on-scroll bg-white rounded-xl p-6 border border-gray-200 shadow-sm transition-all duration-300 hover:shadow-md"
              >
                <div className="mb-4 inline-flex items-center rounded-full px-3 py-1 text-xs font-medium bg-black/10 text-black">
